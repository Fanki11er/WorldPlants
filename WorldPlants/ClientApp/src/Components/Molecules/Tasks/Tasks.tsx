import { HeaderAndImgWrapper, HeaderTask, ImgTask, TasksWrapper } from "./Tasks.styles";
...
import { HeaderPlant, HeaderSpace, HeaderWrapper, ImgAndHeaderWrapper, ImgPlant, ImgTree, TargetTasksWrapper } from "../TargetTasks/TargetTasks.styles";
